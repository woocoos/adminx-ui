...
export const initStoreData = (store: IMockStore) => {
  ...
  // OrgRole
  store.set('OrgRole', 1, { id: 1, name: 'org1group1', kind: 'group' })
  store.set('OrgRole', 2, { id: 2, name: 'org1group2', kind: 'group' })
  store.set('OrgRole', 3, { id: 3, name: 'org1role3', kind: 'role' })
  ...
  store.set('AppMenu', 2, { id: 2, name: '个人中心', kind: 'dir', parentID: 0, appID: 1, app: store.get('App', 1), })
  ...
  store.set('AppMenu', 5, { id: 5, name: '组织协作', kind: 'dir', parentID: 0, appID: 1, app: store.get('App', 1), })
  ...
  store.set('AppMenu', 12, { id: 12, name: '组织管理', kind: 'menu', route: '/org/list', parentID: 11, appID: 1, app: store.get('App', 1), })
  store.set('AppMenu', 13, { id: 13, name: '账户管理', kind: 'menu', route: '/account/list', parentID: 11, appID: 1, app: store.get('App', 1), })
  store.set('AppMenu', 14, { id: 14, name: '应用管理', kind: 'menu', route: '/app/list', parentID: 11, appID: 1, app: store.get('App', 1), })
