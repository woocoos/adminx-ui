 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query appDictItemList($gid:GID!,$where:AppDictItemWhereInput){\n  node(id:$gid){\n   ... on AppDict{\n       id,createdBy,createdAt,updatedBy,updatedAt,appID,code,name,comments,\n       items(where: $where){\n        edges{\n          node{\n            id,name,code,orgID,createdBy,createdAt,dictID,comments,displaySort,status,\n            org{ id,name }\n          }\n        }\n       }\n     }\n   }\n }"): (typeof documents)["query appDictItemList($gid:GID!,$where:AppDictItemWhereInput){\n  node(id:$gid){\n   ... on AppDict{\n       id,createdBy,createdAt,updatedBy,updatedAt,appID,code,name,comments,\n       items(where: $where){\n        edges{\n          node{\n            id,name,code,orgID,createdBy,createdAt,dictID,comments,displaySort,status,\n            org{ id,name }\n          }\n        }\n       }\n     }\n   }\n }"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
