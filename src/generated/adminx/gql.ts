...
const documents = {
    ...
    "query appDictByRefCode($refCodes: [String!]!){\n  appDictByRefCode(refCodes:$refCodes){\n    id,items{\n      id,code,name,refCode\n    }\n  }\n}": types.AppDictByRefCodeDocument,
    "query appDictItemByRefCode($refCode: String!){\n  appDictItemByRefCode(refCode:$refCode){\n    id,code,name,refCode\n  }\n}": types.AppDictItemByRefCodeDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query appDictByRefCode($refCodes: [String!]!){\n  appDictByRefCode(refCodes:$refCodes){\n    id,items{\n      id,code,name,refCode\n    }\n  }\n}"): (typeof documents)["query appDictByRefCode($refCodes: [String!]!){\n  appDictByRefCode(refCodes:$refCodes){\n    id,items{\n      id,code,name,refCode\n    }\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "query appDictItemByRefCode($refCode: String!){\n  appDictItemByRefCode(refCode:$refCode){\n    id,code,name,refCode\n  }\n}"): (typeof documents)["query appDictItemByRefCode($refCode: String!){\n  appDictItemByRefCode(refCode:$refCode){\n    id,code,name,refCode\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
