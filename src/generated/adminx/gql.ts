...
const documents = {
    ...
    "mutation updateUser($userId:ID!,$input: UpdateUserInput!,$basicAddr: UpdateUserAddrInput!){\n  updateUser(userID:$userId,input:$input,basicAddr:$basicAddr){\n    id,createdBy,createdAt,updatedBy,updatedAt,principalName,displayName,gender,\n    basicAddr{email,mobile},userType,creationType,registerIP,status,comments,avatar\n   }\n}": types.UpdateUserDocument,
    ...
    "mutation recoverOrgUser($userId:ID!,$setKind:UserLoginProfileSetKind!,$userInput: UpdateUserInput!,$basicAddr: UpdateUserAddrInput!,$pwdInput: CreateUserPasswordInput){\n  recoverOrgUser( userID:$userId, pwdKind:$setKind, userInput: $userInput, basicAddr :$basicAddr, pwdInput: $pwdInput ){\n    id,createdBy,createdAt,updatedBy,updatedAt,principalName,displayName,gender,\n    basicAddr{email,mobile},userType,creationType,registerIP,status,comments,avatar\n  }\n}": types.RecoverOrgUserDocument,
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation updateUser($userId:ID!,$input: UpdateUserInput!,$basicAddr: UpdateUserAddrInput!){\n  updateUser(userID:$userId,input:$input,basicAddr:$basicAddr){\n    id,createdBy,createdAt,updatedBy,updatedAt,principalName,displayName,gender,\n    basicAddr{email,mobile},userType,creationType,registerIP,status,comments,avatar\n   }\n}"): (typeof documents)["mutation updateUser($userId:ID!,$input: UpdateUserInput!,$basicAddr: UpdateUserAddrInput!){\n  updateUser(userID:$userId,input:$input,basicAddr:$basicAddr){\n    id,createdBy,createdAt,updatedBy,updatedAt,principalName,displayName,gender,\n    basicAddr{email,mobile},userType,creationType,registerIP,status,comments,avatar\n   }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function gql(source: "mutation recoverOrgUser($userId:ID!,$setKind:UserLoginProfileSetKind!,$userInput: UpdateUserInput!,$basicAddr: UpdateUserAddrInput!,$pwdInput: CreateUserPasswordInput){\n  recoverOrgUser( userID:$userId, pwdKind:$setKind, userInput: $userInput, basicAddr :$basicAddr, pwdInput: $pwdInput ){\n    id,createdBy,createdAt,updatedBy,updatedAt,principalName,displayName,gender,\n    basicAddr{email,mobile},userType,creationType,registerIP,status,comments,avatar\n  }\n}"): (typeof documents)["mutation recoverOrgUser($userId:ID!,$setKind:UserLoginProfileSetKind!,$userInput: UpdateUserInput!,$basicAddr: UpdateUserAddrInput!,$pwdInput: CreateUserPasswordInput){\n  recoverOrgUser( userID:$userId, pwdKind:$setKind, userInput: $userInput, basicAddr :$basicAddr, pwdInput: $pwdInput ){\n    id,createdBy,createdAt,updatedBy,updatedAt,principalName,displayName,gender,\n    basicAddr{email,mobile},userType,creationType,registerIP,status,comments,avatar\n  }\n}"];
/**
 * The gql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
