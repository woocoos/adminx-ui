...
export type Query = {
  ...
  /** 登录用户策略视图 */
  orgPolicyView: Array<AppPolicyView>;
  /** 组织策略视图对应的orgPolicy */
  orgPolicyViewOrgPolicies: Array<AppPolicyViewOrgPolicy>;
  /** 组织策略视图角色/用户组选中项 */
...
export type QueryOrgPolicyViewOrgPoliciesArgs = {
  appCode: Scalars['String']['input'];
  orgID?: InputMaybe<Scalars['ID']['input']>;
};
